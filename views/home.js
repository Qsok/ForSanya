    ...
    render() {
        return (
            <div>
                ...
                <ReactJson src={this.state.response} onEdit={(edit)=> {
                    this.setState({id: this.state.id, response: edit.updated_src})
                }} onAdd={(add)=>console.log(add)} onDelete={(del)=>console.log(del)}/>
            </div>
        );
    }
}